    ...
    <div class="admin-settings" id="adminSettings">
        ...
        <div class="admin-content-wrapper" v-if="settings">
            <div class="col-12 px-0 py-3">
                ...
                <p>
                    Anasayfada bulunan editörlerimizin seçtikleri slider alan ayarları
                </p>
            </div>
            <b-card no-body>
                <b-tabs card>
...
<script>
    ...
    export default 
    {
        name:'AdminEditorlerimizinSectikleriSlider',
        layout:'admin',
        ...
        methods:{
            async saveSettings(){
                ...
                .then(value => {
                    if(value)
                    {
                        _this.$repositories.setting.updateHomePageSlider3(_this.slider)
                        .then(res => {
            ...
            getSettings(){
                ...
                .then(res => {
                    if(res) {
                        _this.settings = res.data.response[0];
                        if(_this.settings.home_page_slider_3)
                            _this.slider = JSON.parse(_this.settings.home_page_slider_3);
                        else
                        {
