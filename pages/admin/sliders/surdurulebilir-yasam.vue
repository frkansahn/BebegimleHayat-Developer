    ...
    <div class="admin-settings" id="adminSettings">
        ...
        <div class="admin-content-wrapper" v-if="settings">
            <div class="col-12 px-0 py-3">
                ...
                <p>
                    Anasayfada bulunan sürdürülebilir yaşam slider alan ayarları
                </p>
            </div>
            <b-card no-body>
                <b-tabs card>
...
<script>
    ...
    export default 
    {
        name:'AdminSurdurulebilirYasamSlider',
        layout:'admin',
        ...
        methods:{
            async saveSettings(){
                ...
                .then(value => {
                    if(value)
                    {
                        _this.$repositories.setting.updateHomePageSlider1(_this.slider)
                        .then(res => {
                ...
                .then(res => {
                    if(res) {
                        ...
                        if(_this.settings.home_page_slider_1)
                            _this.slider = JSON.parse(_this.settings.home_page_slider_1);
                        else
                        {
