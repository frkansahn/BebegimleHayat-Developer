                    ...
                    json: {
                        ...
                        "mainEntity": [
                            ...
                            },
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Doğum tarihinizi hesaplamanın birkaç yolu vardır. İlki hangi gün hamile kaldığınızı belirlemektir. Hamile kaldığınız gün üzerinden 38 hafta normal gebelik olarak hesaplanır. Ancak çoğu anne hangi gün hamile kaldığını bilmemektedir. Genellikle 1-2 aylık hamile olduktan sonra belirtilerle öğrenilir.Bu yüzden bir diğer yöntem ise yumurtlama döneminizden hareket etmektir. Son adet gününüz ve adet döngünüzün uzunluğuna göre yumurtlama günleriniz hesaplanır. Yumurtlama zamanı adet döngünüzün genellikle tam ortasında gerçekleşmektedir. Yani 28 gün adet döngünüz varsa 14. gün yumurtlama gününüzdür. Bu hesaplamaya göre ne zaman hamile kalabileceğiniz belirlenir. Ardından aynı şekilde 38 hafta normal gebelik hesaplanır."
                                }
                            },
                            {
                                "@type": "Question",
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Normal gebelik 38 hafta olarak kabul edilir. Ancak hamileliklerin bir kısmında erken doğum veya geç doğum söz konusu olabilir. Bu da öngörülen doğum tarihinin 2 hafta erkene veya geçe çekilmesiyle sonuçlanır. Doğum tarihinin öngörülenden farklı çıkmasının bir diğer sebebi ise hamile kaldığınız günün farklı olmasıdır. Spermlerin vücut içinde 5 güne kadar yaşayabilmesi ve düzensiz adetin yumurtlama zamanını değiştirmesi gibi koşullar hamileliğinizin sonlanacağı günü değiştirebilir. Bu durumda aynı şekilde 1 haftaya kadar değişiklik yaratabilir."
                                }
                            },
                            {
                                "@type": "Question",
...
#gebelikTarihTahminiForm.no-result:after {
    ...
    height: 50px;
    width: 50px;
    background: url(https://api.bebegimlehayat.com/Data/image/extra_small/dogum_tarihi_hesaplama-1684180646598.jpeg) no-repeat left bottom;
    background-size: 100%;
}
